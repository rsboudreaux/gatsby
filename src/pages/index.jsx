		...
		<Parallax pages={5}>
			...
			<Content speed={0.4} offset={3}>
				...
				<Inner>
					...
					<AboutDesc>
						Why? Well, how'd you become king, then? I don't want to talk to you no more, you empty-headed animal food trough water! I fart in your general direction! Your mother was a hamster and your father smelt of elderberries! Now leave before I am forced to taunt you a second time!

						Shh! Knights, I bid you welcome to your new home. Let us ride to Camelot! Ni! Ni! Ni! Ni! The Lady of the Lake, her arm clad in the purest shimmering samite, held aloft Excalibur from the bosom of the water, signifying by divine providence that I, Arthur, was to carry Excalibur. That is why I am your king.

						Bring her forward! We found them. You can't expect to wield supreme power just 'cause some watery tart threw a sword at you! Why? Ah, now we see the violence inherent in the system!
					</AboutDesc>
			...
			<Content speed={0.4} offset={4}>
				...
				<Footer>
					<script type="text/javascript" id="hs-script-loader" async defer src="//js.hs-scripts.com/4661626.js"></script>
				</Footer>
